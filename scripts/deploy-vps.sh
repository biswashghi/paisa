...
LOCAL_PAISA_INTERNAL_ADMIN_TOKEN="${PAISA_INTERNAL_ADMIN_TOKEN:-}"
REPO_HOST=""
...
if [[ -z "$LOCAL_PAISA_INTERNAL_ADMIN_TOKEN" ]]; then
  echo "PAISA_INTERNAL_ADMIN_TOKEN is required." >&2
  exit 1
fi
...
ENV_PAYLOAD_BASE64="$(
  printf '%s\n' \
    ...
    "PAISA_INTERNAL_ADMIN_TOKEN=${LOCAL_PAISA_INTERNAL_ADMIN_TOKEN}" \
